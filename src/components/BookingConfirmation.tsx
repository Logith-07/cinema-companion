        ...
        <div className="p-6 space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="font-medium">{seats.map((s) => s.id).join(', ')}</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="font-mono font-bold text-primary">{bookingId}</p>
            </div>
            <div className="text-right">
              <p className="text-xs text-muted-foreground">Paid via {paymentMethod.label}</p>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 bg-foreground rounded-lg flex items-center justify-center">
                <div className="w-12 h-12 bg-background rounded grid grid-cols-3 gap-0.5 p-1">
                  {[...Array(9)].map((_, i) => (
